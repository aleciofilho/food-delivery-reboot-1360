class OrderRepository
  ...
  def all_my_undelivered(current_user)
    all_undelivered.select { |order| order.employee == current_user }
  end

  def find_undelivered_by_index(current_user, index)
    all_my_undelivered(current_user)[index]
  end
